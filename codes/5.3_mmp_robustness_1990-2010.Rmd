...
We add this "normalized" dataset to the pre-existing one. Furthermoe, we only keep 10-year windows backawrds:
```{r}
year_window = 11
...
etable(reg_list_imm[1:4],
         file = paste0(dir$results,"imm_1990-2010.txt"), 
       fitstat=c('n', 'ar2'),
       replace = TRUE)
...
#        file = paste0(dir$results,"imm_il_1990-2010.txt"), 
#        fitstat=c('n', 'ar2'),
#        replace = TRUE)
...
#        file = paste0(dir$results,"imm_l_1990-2010.txt"), 
#        fitstat=c('n', 'ar2'),
#        replace = TRUE)
...
etable(c(reg_list_imm_il[1:4],reg_list_imm_l[1:4]),
       file = paste0(dir$results,"imm_il_l_1990-2010.txt"),
