...
etable(reg_list_imm[1:4],
         file = paste0(dir$results,"imm_100pop.txt"), 
       fitstat=c('n', 'ar2'),
       replace = TRUE)
...
#        file = paste0(dir$results,"imm_il_8yr.txt"), 
#        fitstat=c('n', 'ar2'),
#        replace = TRUE)
...
#        file = paste0(dir$results,"imm_l_8yr.txt"), 
#        fitstat=c('n', 'ar2'),
#        replace = TRUE)
...
etable(c(reg_list_imm_il[1:4],reg_list_imm_l[1:4]),
       file = paste0(dir$results,"imm_il_l_100pop.txt"),
