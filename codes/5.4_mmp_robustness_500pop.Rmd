...
mmp = 
  ...
  filter(year >= 1989 &  pop_2010 <= 500000)
```
...
etable(reg_list_imm[1:4],
         file = paste0(dir$results,"imm_500pop.txt"), 
       fitstat=c('n', 'ar2'),
       replace = TRUE)
...
#        file = paste0(dir$results,"imm_il_500pop.txt"), 
#        fitstat=c('n', 'ar2'),
#        replace = TRUE)
...
#        file = paste0(dir$results,"imm_l_500pop.txt"), 
#        fitstat=c('n', 'ar2'),
#        replace = TRUE)
...
etable(c(reg_list_imm_il[1:4],reg_list_imm_l[1:4]),
       file = paste0(dir$results,"imm_il_l_500pop.txt"),
